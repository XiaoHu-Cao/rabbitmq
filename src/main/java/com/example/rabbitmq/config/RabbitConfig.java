 ...
 *//*
 ...
 public class RabbitConfig {
     ...
     public static final String EXCHANFE_ORDER = "user-order-queue";
...
/**
     ...
     public TopicExchange userOrderExchange(){
         return new TopicExchange(EXCHANFE_ORDER,true,false);
     }

     @Bean
     public Binding bindingOrder(){
         return BindingBuilder.bind(queueOrder()).to(userOrderExchange()).with(ROUTINGKEY_D);
     }
