...
import com.example.rabbitmq.rabbitmq.SimpleListener;
import com.example.rabbitmq.rabbitmq.UserOrderListener;
...
public class RabbitmqConfig {
    ...
    public SimpleRabbitListenerContainerFactory listenerContainer(){
        ...
        factory.setTxSize(1);
        factory.setAcknowledgeMode(AcknowledgeMode.AUTO); //消息确认机制三种模式
        return factory;
    }
